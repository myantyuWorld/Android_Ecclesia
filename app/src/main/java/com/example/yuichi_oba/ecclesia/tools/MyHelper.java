...
public class MyHelper extends SQLiteOpenHelper {
    ...
    public static String Q_CREATE_T_RESERVE = "CREATE TABLE  t_reserve  ( `re_id` TEXT, `re_overview` TEXT, `re_startday` TEXT, `re_endday` TEXT, `re_starttime` TEXT, `re_endtime` TEXT, `re_switch` INTEGER, `re_fixture` TEXT, `re_remarks` TEXT, `re_priority` INTEGER, `com_id` TEXT, `emp_id` TEXT, `room_id` BLOB, `pur_id` TEXT, `re_applicant` TEXT, PRIMARY KEY(`re_id`), FOREIGN KEY(`com_id`) REFERENCES `m_company`(`com_id`), FOREIGN KEY(`pur_id`) REFERENCES `m_purpose`(`pur_id`), FOREIGN KEY(`re_applicant`) REFERENCES t_emp(emp_id) )";    public static String Q_CREATE_T_MEMBER = "CREATE TABLE  t_member  ( `re_id` TEXT, `mem_id` TEXT, PRIMARY KEY(`re_id`,`mem_id`) )";
