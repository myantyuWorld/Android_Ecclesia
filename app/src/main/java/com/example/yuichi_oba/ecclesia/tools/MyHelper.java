...
public class MyHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        //*** CREATE TABLE ***//
        db.execSQL(Query.Q_CREATE_M_COMPANY.getString());
        db.execSQL(Query.Q_CREATE_M_DEPART.getString());
        db.execSQL(Query.Q_CREATE_M_POSITION.getString());
        db.execSQL(Query.Q_CREATE_M_PURPOSE.getString());
        db.execSQL(Query.Q_CREATE_M_ROOM.getString());
        db.execSQL(Query.Q_CREATE_M_EMP.getString());
        db.execSQL(Query.Q_CREATE_M_OUT.getString());
        db.execSQL(Query.Q_CREATE_M_ADMIN.getString());
        db.execSQL(Query.Q_CREATE_M_TERMINAL.getString());
        db.execSQL(Query.Q_CREATE_T_RESERVE.getString());
        db.execSQL(Query.Q_CREATE_T_MEMBER.getString());
        db.execSQL(Query.Q_CREATE_T_EXTENSION.getString());

        db.execSQL(Query.Q_VIEW_V_EMPLOYEE.getString());
        db.execSQL(Query.Q_VIEW_V_OUT_EMP.getString());
        db.execSQL(Query.Q_VIEW_V_RESERVE_MEMBER.getString());
        db.execSQL(Query.Q_VIEW_V_RESERVE_OUT_MEMBER.getString());


        db.execSQL(Query.Q_INSERT_COMPANY.getString());
        db.execSQL(Query.Q_INSERT_DEPART.getString());
        db.execSQL(Query.Q_INSERT_POSITION.getString());
        db.execSQL(Query.Q_INSERT_PURPOSE.getString());
        db.execSQL(Query.Q_INSERT_ROOM.getString());
        db.execSQL(Query.Q_INSERT_EMP.getString());
        db.execSQL(Query.Q_INSERT_OUT.getString());
        db.execSQL(Query.Q_INSERT_ADMIN.getString());
