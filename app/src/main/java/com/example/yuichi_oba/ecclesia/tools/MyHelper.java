...
public class MyHelper extends SQLiteOpenHelper {
    ...
    public static String Q_CREATE_T_RESERVE = "CREATE TABLE  t_reserve  ( `re_id` TEXT, `re_overview` TEXT, `re_startday` TEXT, `re_endday` TEXT, `re_starttime` TEXT, `re_endtime` TEXT, `re_switch` INTEGER, `re_fixture` TEXT, `re_remarks` TEXT, `re_priority` INTEGER, `com_id` TEXT, `emp_id` TEXT, `room_id` TEXT, `pur_id` TEXT, `re_applicant` TEXT, PRIMARY KEY(`re_id`), FOREIGN KEY(`com_id`) REFERENCES `m_company`(`com_id`), FOREIGN KEY(`pur_id`) REFERENCES `m_purpose`(`pur_id`), FOREIGN KEY(`re_applicant`) REFERENCES t_emp(emp_id) )";
    ...
    public static String Q_VIEW_V_OUT_EMP = "CREATE VIEW v_out_emp as select x.re_id, x.mem_id, y.out_name, y.out_tel, y.out_mailaddr, y.dep_name, y.pos_name, y.outemp_priority, z.com_id, z.com_name from (t_member x inner join m_out y on x.mem_id = y.out_id) inner join m_company z on y.com_id = z.com_id";
    ...
    public static String Q_INSERT_RESERVE = "INSERT INTO `t_reserve` (re_id,re_overview,re_startday,re_endday,re_starttime,re_endtime,re_switch,re_fixture,re_remarks,re_priority,com_id,emp_id,room_id,pur_id,re_applicant) VALUES ('0001','新規プロジェクト報告','2018/02/15','2018/02/15','08：00','09：00',1,'プロジェクタ','なし',10,'0001','0002','0001','0001','0002'),  " +
            " ('0002','進捗の会議','2018/02/14','2018/02/14','08：00','10：30',1,'プロジェクタ','なし',5,'0002','0002','0002','0002','0002'),  " +
            " ('0003','パンフレット説明','2018/02/14','2018/02/14','11：00','13：30',1,'プロジェクタ','なし',4,'0003','0001','0003','0003','0001'),  " +
            " ('0004','売り込み','2018/02/14','2018/02/14','08：00','09：00',0,'プロジェクタ','なし',6,'0000','0003','0004','0003','0002'),  " +
            " ('0005','決算報告','2018/02/14','2018/02/14','10：00','11：30',0,'プロジェクタ','なし',1,'0000','0003','0001','0002','0002'),  " +
            " ('0006','打合せ','2018/02/13','2018/02/13','09：30','10：30',1,'プロジェクタ','なし',4,'0012','0001','0002','0001','0001'),  " +
            " ('0030','打合せ','2018/02/13','2018/02/13','09：30','10：30',1,'プロジェクタ','なし',4,'0012','0001','0002','0001','0001'),  " +
            " ('0007','打合せ','2018/02/13','2018/02/13','10：00','12：00',0,'プロジェクタ','なし',4,'0000','0003','0003','0004','0003'),  " +
            " ('0008','打合せ','2018/02/13','2018/02/13','10：00','12：00',1,'プロジェクタ','なし',5,'0002','0004','0004','0003','0004'),  " +
            " ('0009','打合せ','2018/02/13','2018/02/13','08：00','09：30',1,'プロジェクタ','なし',6,'0004','0005','0001','0004','0005'),  " +
            " ('0010','打合せ','2018/02/13','2018/02/13','10：00','12：00',1,'プロジェクタ','なし',4,'0005','0002','0002','0001','0002'),  " +
            " ('0011','売り込み','2018/02/15','2018/02/15','12：30','13：30',1,'プロジェクタ','なし',10,'0002','0001','0003','0003','0001'),  " +
            " ('0012','進捗の会議','2018/02/15','2018/02/15','10：00','12：00',1,'プロジェクタ','なし',4,'0001','0002','0004','0002','0002'),  " +
            " ('0013','新規プロジェクト報告','2018/02/15','2018/02/15','09：30','10：30',1,'プロジェクタ','なし',4,'0002','0005','0001','0004','0005'),  " +
            " ('0014','進捗の会議','2018/02/15','2018/02/15','10：00','12：00',1,'プロジェクタ','なし',4,'0004','0007','0001','0005','0007'),  " +
            " ('0015','パンフレット説明','2018/02/15','2018/02/15','10：00','12：00',1,'プロジェクタ','なし',5,'0011','0001','0002','0001','0001'),  " +
            " ('0016','売り込み','2018/02/15','2018/02/15','08：00','09：30',1,'プロジェクタ','なし',6,'0002','0002','0003','0002','0002'),  " +
            " ('0017','Ostraca','2018/02/14','2018/02/14','12：00','14：30',1,'プロジェクタ','なし',5,'0002','0002','0001','0002','0002'),  " +
            " ('0018','Ecclesiaプレゼン','2018/02/14','2018/02/14','15：00','17：30',1,'プロジェクタ','なし',5,'0002','0002','0002','0002','0002'),  " +
            " ('0019','猫の良さを語る会','2018/02/14','2018/02/14','18：00','19：30',1,'プロジェクタ','なし',5,'0002','0002','0001','0002','0002'),  " +
            " ('0020','テスト','2018/02/14','2018/02/14','08：00','10：30',1,'プロジェクタ','なし',5,'0002','0002','0003','0002','0002'),  " +
            " ('0021','テスト1','2018/02/14','2018/02/14','01：00','03：30',1,'プロジェクタ','なし',5,'0002','0002','0003','0002','0002'),  " +
            " ('0022','テスト2','2018/02/14','2018/02/14','05：00','07：30',1,'プロジェクタ','なし',5,'0002','0002','0004','0002','0002'),  " +
            " ('0023','テスト3','2018/02/15','2018/02/15','10：00','12：00',1,'プロジェクタ','なし',4,'0001','0001','0004','0003','0001');";
